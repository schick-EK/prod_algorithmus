...
export default async function ConductPage({
  ...
  // Get all stations for this work area
  ...
  // Get all activity types for this study
  ...
  // Get station-activity mappings for all stations in this work area
  const allSatMappings = stationList.length > 0
